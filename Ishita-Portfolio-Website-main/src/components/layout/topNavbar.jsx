        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden">
            <Motion.button
              ...
              className="inline-flex items-center justify-center p-2 rounded-full bg-black/20 backdrop-blur-lg text-white hover:bg-black/30 transition-all duration-300"
